import unittest
from src import piglatin, helpers
from os import linesep

class TestPigLatinMethods(unittest.TestCase):

    """
    Tests for helpers._split_words()
    """
    ...
    def test_split_words_splits_on_space(self):
        ...
        for (sentence, words) in test_sentences.iteritems():
            test_words = helpers._split_words(sentence)
            self.assertEqual(
                words,
                test_words,
                """
    ...
    def test_join_words_joins_elements(self):
        ...
        for (words, sentence) in test_words:
            test_sentence = helpers._join_words(words)
            self.assertEqual(
                sentence,
                test_sentence,
                """
    ...
    """
    Tests for helpers._trim_punctuation()
    """
    def test_trim_punctuation(self):
        ...
        for (word, trimmed_word) in test_words:
            test_trimmed_word = helpers._trim_punctuation(word)
            self.assertEqual(
                trimmed_word,
                test_trimmed_word,
                """
    ...
    def test_trim_punctuation_preserves_contractions(self):
        ...
        for contraction in test_contractions:
            test_trim = helpers._trim_punctuation(contraction)
            self.assertEqual(
                contraction,
                test_trim,
                """
    ...
    """
    Tests for helpers._fix_title_case()
    """
    def test_fix_title_case_matches_title_case(self):
        ...
        for (word, match_word, capitalization) in test_words:
            test_capitalization = helpers._fix_title_case(word, match_word)
            self.assertEqual(
                capitalization,
                test_capitalization,
                """
    ...
    """
    Tests for helpers._convert_word()
    """
    def test_convert_word_works_with_dereks_examples(self):
        ...
        for (word, translation) in dereks_examples:
            test_translation = helpers._convert_word(word)
            self.assertEqual(
                translation,
                test_translation,
                """
